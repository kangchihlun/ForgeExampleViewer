...
{
    //Share access token between users is only valid in this
    //case, where all users are accessing the same information (2-legged.
    //If your app uses per-user data (3-legged), DOT NOT use this approach.
