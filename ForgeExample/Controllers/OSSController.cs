...
namespace forgesample.Controllers
{
    ...
    {
        //Upload a file from the client(browser)
        //directly to Autodesk Forge is possible, 
        //but requires giving the client a write-enabled 
        //access token, which is NOT SECURE.
